...
contract('Oracles', async (accounts) => {
  ...
  it('can request flight status: not on time', async () => {
    ...
    console.log('F', web3.utils.fromWei(contractBalanceBefore));
    let balanceOfPassengerBeforeTransaction = await web3.eth.getBalance(passenger1);
    console.log('Fwww', web3.utils.fromWei(balanceOfPassengerBeforeTransaction));
    ...
    console.log('Fw', web3.utils.fromWei(contractBalanceAfter));

    let balanceOfPassengerAfterTransaction = await web3.eth.getBalance(passenger1);
    console.log('Fwwww', web3.utils.fromWei(balanceOfPassengerAfterTransaction));
